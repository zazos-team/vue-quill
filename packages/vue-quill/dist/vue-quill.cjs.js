...
const QuillEditor = vue.defineComponent({
    ...
    setup: (props, ctx) => {
        ...
        const registerModule = (moduleName, module) => {
            ...
            if ((Quill__default === null || Quill__default === void 0 ? void 0 : Quill__default.imports) && moduleName in Quill__default.imports) {
                return;
            }
        ...
        const composeOptions = () => {
            ...
            if (props.modules) {
                ...
                clientOptions.modules = defu.defu(clientOptions.modules, modules);
            }
            return defu.defu(props.globalOptions, props.options, clientOptions);
        };
